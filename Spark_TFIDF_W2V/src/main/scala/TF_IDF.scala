...
object TF_IDF {
  def main(args: Array[String]): Unit = {
   ...
   // val documents = sc.textFile("data/10 abstracts.txt")
    val documents = sc.wholeTextFiles("/Users/lakshmikorrapati/Desktop/Spark_TFIDF_W2V/data/abstracts",minPartitions = 2)
